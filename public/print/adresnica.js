function printAdresnica(adresnica, user){
  ...
  styleArr.push('.header {display:flex; justify-content:space-between;}');
  ...
  header = '<div class="header">' +
              '<div class="padded">' + adresnica['Сериски'] + '</div>' +
              '<h2>Адресница</h2>' +
  ...
  hs = '<div class="hs" style="position:relative; top:-4vh;">' + lhs + rhs + '</div>';
